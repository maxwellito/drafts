...
(function($){
	$.fn.ieSucks=function(options){
		...
		var  $note=$('<span><span style="position:relative;"><img src="'+options.imgPath+'/IE-warning_note.png" style="border:0px;width:100%;height:100%;"/></span></span>').css(options.css.note)
			,$body=$('body')
			,$window=$(window)
			,$document=$(document)
			...
			,$info=$('<div style="position:fixed;left:30px;bottom:30px;"><a href="https://github.com/jolic/ieSucks" target="_blank" style="font-size:1em;color:#bbc;text-decoration:none;">Like it? Get it and use it for free here!</a></div>')
